# ==============================================================================
# Simulation Study: Scenario 3 (2 Clusters, Exponential Distribution)
# ==============================================================================
#
...
# Output:
#   - all_results_s3_[scenario]_n_[n_total].rds: Complete simulation results
#   - predict_timepoints_s3_[scenario]_n_[n_total].csv: Results by landmark time
#   - predict_if_s3_[scenario]_n_[n_total].csv: Results by information fraction
#
# ==============================================================================
...
saveRDS(all_results, paste0("all_results_s3_", scenario, "_n_", n_total, ".rds"))
rm(all_results)
gc()
...
write.csv(summary_by_time, 
          paste0("predict_timepoints_s3_", scenario, "_n_", n_total, ".csv"))
...
write.csv(summary_by_IF, paste0("predict_if_s3_", scenario, "_n_", n_total, ".csv"))
