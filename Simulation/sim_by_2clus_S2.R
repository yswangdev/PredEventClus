...
# Output:
#   - all_results_s2_n_[n_total].rds: Complete simulation results
#   - predict_timepoints_s2_n_[n_total].csv: Results by landmark time
#   - predict_if_s2_n_[n_total].csv: Results by information fraction
#
# ==============================================================================
...
saveRDS(all_results, paste0("all_results_s2_n_", n_total,".rds"))
...
write.csv(summary_by_time, paste0("predict_timepoints_s2_n_", n_total, ".csv"))
...
write.csv(summary_by_IF, paste0("predict_if_s2_n_", n_total, ".csv"))
